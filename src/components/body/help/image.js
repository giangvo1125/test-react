                ...
                <div className="hentry-box">
                    <figure className="entry-image">
                        <blockquote 
                            ...
                            data-instgrm-permalink={this.props.link || ''}
                            data-instgrm-version="8" 
                            style={{background:'#FFF', border:'0', borderRadius:'3px', boxShadow:'0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15)', margin: '1px', maxWidth:'600px', padding:'0', width:'99.375%', width:'-webkit-calc(100% - 2px)', width:'calc(100% - 2px)'}}
                        >
                            <div style={{padding:"8px"}}>
                                <div 
                                    style={{background: '#F8F8F8', lineHeight: 0, marginTop:'40px', padding:'50% 0', textAlign:'center', width:'100%'}}
                                >
                                ...
                                <p style={{color:'#c9c8cd', fontFamily:'Arial,sans-serif', fontSize:'14px', lineHeight:'17px', marginBottom:'0', marginTop:'8px', overflow:'hidden', padding:'8px 0 7px', textAlign:'center', textOverflow:'ellipsis', whiteSpace:'nowrap'}}>
                                    <a 
                                        ...
                                        target="_blank">{this.props.content || ''}
                                    </a>
                                </p>
                            </div>
                        </blockquote>
